...
*An in-memory PE header (MZ) was detected, indicating a loaded executable payload--Malware loaded an executable directly into RAM instead of writing it to disk*
